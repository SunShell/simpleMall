...
function renderData(data) {
    ...
    $(data).each(function (i) {
        html += '<div class="listOne" exampleId="'+this.id+'" '+((i+1)%3===0 ? 'style="margin-right: 0;"' : '')+'>'+
            '<div class="listOneImgBig"><img src="'+getDatePath(this.image,this.created_at)+'"></div>'+ this.name +
            '</div>';
    });
